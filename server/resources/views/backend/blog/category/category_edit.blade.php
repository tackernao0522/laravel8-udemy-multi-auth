                        ...
                        <div class="table-responsive">
                            <form method="POST" action="{{ route('blogCategory.update', $blogCategory->id) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="blog_category_name_ja" class="form-control" value="{{ old('blog_category_name_ja', $blogCategory->blog_category_name_ja) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="blog_category_name_en" class="form-control" value="{{ old('blog_category_name_en', $blogCategory->blog_category_name_en) }}">
